...
function lfs_download_and_extact() {
    echo "Preparing nginx:";

    # Resolve some information
    local LFS_FILE="${OPENSHIFT_NGINX_DIR}/usr/nginx-${NGINX_VERSION}.tar.gz"
    local DOWNLOAD_FILE="${OPENSHIFT_NGINX_DIR}/usr/nginx-${NGINX_VERSION}_actual.tar.gz"
